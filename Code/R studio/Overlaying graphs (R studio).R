...
# This file contains the overlaying graphs used in thesis material selection 
...
super.comb <- left_join(python.data20250512_1030, python.data20250424)



python.data20250424 %>% 
  ggplot(aes(x = Time..min., y = Reflectance_590)) +
  geom_point(col = "#ff7f0e", size = 2) +
  geom_line(col = "#ff7f0e", size = 1) +
    scale_y_continuous(name = "Reflectance", limits = c(6000, 8500)) +
    scale_x_continuous(name = "Time (min)", limits = c(74, 105)) 


python.data20250512_1030 %>% 
  ggplot(aes(x = Time..min., y = Reflectance_590)) +
  geom_point( col = "#1f77b4", size = 2) +
  geom_line( col = "#1f77b4", size = 1) +
    scale_y_continuous(name = "Reflectance", limits = c(4600, 5150)) +
    scale_x_continuous(name = "Time (min)", limits = c(74, 105)) 
